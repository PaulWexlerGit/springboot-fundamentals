...
public class GenreController {
     ...
     */
    @Operation(summary = "Creates a new genre", description = "Creates a new genre with the provided details.")
    @PostMapping
     ...
     */
    @Operation(summary = "Retrieves all genres", description = "Retrieves a list of all genres.")
    @GetMapping
     ...
     */
    @Operation(summary = "Retrieves a genre by its ID", description = "Retrieves a genre by its ID.")
    @GetMapping("/{id}")
     ...
     */
    @Operation(summary = "Updates an existing genre", description = "Updates an existing genre with the provided details.")
    @PutMapping("/{id}")
     ...
     */
    @Operation(summary = "Deletes a genre by its ID", description = "Deletes a genre by its ID.")
    @DeleteMapping("/{id}")
